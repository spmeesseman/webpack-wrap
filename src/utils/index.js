...
const {
    ...
    getExcludes, lowerCaseFirstChar, randomNumber, requireResolve, relativePath, resolvePath, wpwVersion
} = require("./utils");
...
module.exports = {
    ...
    relativePath, resolvePath, requireResolve, uniq, utils, validateSchema, wpwVersion,
