...
module.exports = {
    ...
    pickBy, pickNot, getSchemaDefinition, getSchemaVersion, pushIfNotExists, relativePath, resolvePath, requireResolve,
    SchemaDirectory, typedefs, uniq, utils, validateSchema, WpBuildConsoleLogger, WpBuildError, WpwMessage, WpwMessageProps, WpwRegex,
