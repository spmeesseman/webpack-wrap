...
/** @typedef {import("./rc").TypeWpwVsCodeConfig} TypeWpwVsCodeConfig */
...
/** @typedef {import("./rc").WpwBooleanDefaultTrue} WpwBooleanDefaultTrue */
...
/** @typedef {import("./rc").WpwBooleanDefaultFalse} WpwBooleanDefaultFalse */
